...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
         <% 
        int c=1;
        String query = "select * from angularjs";
     ...
     <div class="edit-bar"> 
               ...
               <form  method="post" action="Del-angularjs.jsp">
               <input type="hidden" name="qid" value="<%= rs.getString(1) %>">
               <button id="delete" type="submit" >Delete</button>
               </form> 
               <form  method="post" action="Edit-angularjs.jsp">
               <input type="hidden" name="qid" value="<%= rs.getString(1) %>">
      ...
      <%
       ...
       <div class="Ques-box" 
           ...
           <form method="post" action="angularjs-Ques.jsp">
