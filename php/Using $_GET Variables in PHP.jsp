...
<html>
    ...
    <body>
      ...
      <div class="video">
        <p id="title">
Using $_GET Variables in PHP</p>  

<iframe width="900" height="500" src="https://www.youtube.com/embed/k5uzEGxx0VE?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
