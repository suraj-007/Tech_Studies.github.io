...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">ConnectionStrings in web.config configuration file - Part 3</p>  

<iframe width="900" height="500" src="https://www.youtube.com/embed/pBCPc44CE74?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
