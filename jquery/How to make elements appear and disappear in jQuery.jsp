...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">How to make elements appear and disappear in jQuery</p>  
      
      <iframe width="900" height="500" src="https://www.youtube.com/embed/6HWaZIfUZVg?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
       ...
       <div class="Header">
        <p id="p"> Jquery Lectures</p>
                   ...
                   <div class="java">
        <ul>
        <li><a href="Quiz-jquery.jsp">Quiz-ajax</a></li><br>   
