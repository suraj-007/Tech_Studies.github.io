...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">How to add jQuery to your website</p>  
       <iframe width="900" height="500" src="https://www.youtube.com/embed/EwUOsRlDTLQ?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
