...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">jQuery syntax and differences from JavaScript</p>  
      <iframe width="900" height="500" src="https://www.youtube.com/embed/9TwYaSnb2GI?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
