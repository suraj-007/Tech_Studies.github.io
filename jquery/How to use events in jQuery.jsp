...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">How to use events in jQuery</p>  
      <iframe width="900" height="500" src="https://www.youtube.com/embed/9bCrSoSNp_w?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
