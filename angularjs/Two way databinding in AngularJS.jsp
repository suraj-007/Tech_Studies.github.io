...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">Two way databinding in AngularJS</p>  
 
        <iframe width="900" height="500" src="https://www.youtube.com/embed/2QB1S5y5DIk?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
