...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">AngularJS ng src directive</p>  
      <iframe width="900" height="500" src="https://www.youtube.com/embed/YY_-BB_lZDI?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
