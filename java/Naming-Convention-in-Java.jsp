...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
 <div class="video">
        <p id="title">Naming Convention in Java</p>
        <iframe width="900" height="500" src="https://www.youtube.com/embed/VtDBsy_enkE?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
      <div class="Header">
