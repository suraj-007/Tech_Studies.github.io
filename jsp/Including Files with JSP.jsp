...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title"> Including Files with JSP</p>  
<iframe width="900" height="500" src="https://www.youtube.com/embed/EWbYj0qoNHo?rel=0&amp;showinfo=0&amp;start=10" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
