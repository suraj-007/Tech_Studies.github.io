...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">CSS Box Model Part 2</p> 

<iframe width="900" height="500" src="https://www.youtube.com/embed/l3Cu_s61zaU?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> 
