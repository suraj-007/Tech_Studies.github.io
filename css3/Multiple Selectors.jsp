...
<html>
    ...
    <body>
      ...
      <div class="video">
        <p id="title">
Multiple selectors and writing rule for more than one element</p>  
<iframe width="900" height="500" src="https://www.youtube.com/embed/JT0gyzbpD2U?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
