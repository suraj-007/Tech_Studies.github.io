...
<html>
    ...
    <body>
      ...
      <div class="video">
        <p id="title">
Add a line to header and border property</p>  
<iframe width="900" height="500" src="https://www.youtube.com/embed/hCoMjvtsyPA?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
