...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">The bootstrap grid explained</p>  
<iframe width="900" height="500" src="https://www.youtube.com/embed/g3LRU3JF-rQ?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
