...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">Nesting the grid</p>  
<iframe width="900" height="500" src="https://www.youtube.com/embed/x6uafDNy-F4?rel=0&amp;showinfo=0&amp;start=5" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
