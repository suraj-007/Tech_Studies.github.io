...
<html>
    ...
    <body>
        ...
        <div class="wrapper">
         <% 
        int c=1;
        String query = "select * from bootstrap3";
     ...
     <div class="edit-bar"> 
               ...
               <form  method="post" action="Del-bootstrap.jsp">
               <input type="hidden" name="qid" value="<%= rs.getString(1) %>">
               <button id="delete" type="submit" >Delete</button>
               </form> 
               <form  method="post" action="Edit-bootstrap.jsp">
               <input type="hidden" name="qid" value="<%= rs.getString(1) %>">
      ...
      <%
       ...
       <div class="Ques-box" 
           ...
           <form method="post" action="bootstrap-Ques.jsp">
