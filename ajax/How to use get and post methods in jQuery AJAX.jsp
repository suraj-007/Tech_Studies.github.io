...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">How to use get and post methods in jQuery AJAX</p>  
        
</div>
      <div class="Header">
        <p id="p"> Ajax Lectures</p>
      </div>
       <iframe width="900" height="500" src="https://www.youtube.com/embed/MG9itGX1hD0?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
     </div>   
              <div class="java">
        <ul>
