...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">Get data from a database without refreshing the browser</p>  
        <iframe width="900" height="500" src="https://www.youtube.com/embed/ejN-oAw9vC0?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
