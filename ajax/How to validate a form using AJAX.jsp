...
<html>
    ...
    <body>
        ...
        <div class="wrapper">    
      <div class="video">
        <p id="title">How to validate a form using AJAX</p>  
        
</div>
      <div class="Header">
        <p id="p"> Ajax Lectures</p>
      </div>
     <iframe width="900" height="500" src="https://www.youtube.com/embed/L7Sn-f36TGM?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>   
      </div>        
